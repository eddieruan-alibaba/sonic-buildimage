...
LIBNEXTHOPGROUP_VERSION = 1.0.0
LIBNEXTHOPGROUP_NAME = libnexthopgroup

LIBNEXTHOPGROUP = $(LIBNEXTHOPGROUP_NAME)_$(LIBNEXTHOPGROUP_VERSION)_$(CONFIGURED_ARCH).deb
$(LIBNEXTHOPGROUP)_SRC_PATH = $(SRC_PATH)/sonic-swss-common
$(LIBNEXTHOPGROUP)_VERSION = $(LIBNEXTHOPGROUP_VERSION)
$(LIBNEXTHOPGROUP)_NAME = $(LIBNEXTHOPGROUP_NAME)
$(LIBNEXTHOPGROUP)_DEPENDS += $(LIBNL3_DEV) $(LIBNL_GENL3_DEV) \
                            $(LIBNL_ROUTE3_DEV) $(LIBNL_NF3_DEV) \
                            $(LIBNL_CLI_DEV) $(LIBYANG_DEV) $(LIBYANG) $(LIBYANG_CPP) $(LIBYANG_PY3)
$(LIBNEXTHOPGROUP)_RDEPENDS += $(LIBNL3) $(LIBNL_GENL3) \
                             $(LIBNL_ROUTE3) $(LIBNL_NF3) $(LIBNL_CLI) $(LIBYANG)
$(LIBNEXTHOPGROUP)_WHEEL_DEPENDS += $(SONIC_YANG_MGMT_PY3) $(SONIC_YANG_MODELS_PY3)
SONIC_DPKG_DEBS += $(LIBNEXTHOPGROUP)

LIBNEXTHOPGROUP_DEV = $(LIBNEXTHOPGROUP_NAME)-dev_$(LIBNEXTHOPGROUP_VERSION)_$(CONFIGURED_ARCH).deb
$(eval $(call add_derived_package,$(LIBNEXTHOPGROUP),$(LIBNEXTHOPGROUP_DEV)))
