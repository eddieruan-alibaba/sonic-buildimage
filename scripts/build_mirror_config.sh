...
DEFAULT_MIRROR_URLS=http://debian-archive.trafficmanager.net/debian/,http://mirrors.cloud.aliyuncs.com/ubuntu,http://us.archive.ubuntu.com/ubuntu
DEFAULT_MIRROR_SECURITY_URLS=http://debian-archive.trafficmanager.net/debian-security/,http://mirrors.cloud.aliyuncs.com/ubuntu,http://us.archive.ubuntu.com/ubuntu
